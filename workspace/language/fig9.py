...
fig.update_yaxes(range=(0.64, 1.002), title="Correlation").update_xaxes(range=(0, 64), title="Top eigenvectors")
fig.update_layout(title="Feature activation approximation", title_x=0.5)

fig.update_layout(width=400, height=300, margin=dict(l=0, r=0, t=30, b=0))
...
fig.update_layout(width=400, height=300, margin=dict(l=0, r=0, t=30, b=0), showlegend=False)
...
fig.update_layout(width=600, height=300, margin=dict(l=0, r=0, t=0, b=0), showlegend=False)
fig.write_image(f"C:\\Users\\thoma\\Downloads\\correlation_training.pdf", engine="kaleido")
# %%
nmse = [0.412, 0.376, 0.373, 0.353, 0.361]
